 ...
 */
                                                ...
                                                )
 {
  ...
  _InfoPlikow.
      push_back(InfoPlikuDoRysowania(NazwaPliku,SR_PunktowyNiejednorodny,
                                     DOMYSLNA_SZEROKOSC,
                                     DOMYSLNY_KOLOR,
                                     DOMYSLNY_STYL));
  return _InfoPlikow.back();
 }
 ...
 */
 ...
 {
   DodajNazwePliku(NazwaPliku,SR_Ciagly,DOMYSLNA_SZEROKOSC);
   return _InfoPlikow.back();
 }
 ...
 */
 ...
 {
   DodajNazwePliku(NazwaPliku,SR_Punktowy,DOMYSLNA_SZEROKOSC);
   return _InfoPlikow.back();
 }
 ...
 */
                                             ...
                                             )
 {
  ...
  for (; Nazwy != _InfoPlikow.end(); ++Nazwy ) {
       if (Nazwy->WezSposobRys() == SR_PunktowyNiejednorodny) continue;
    //       OSStrm.empty();
       Polecenie += *Sep;
       Polecenie += " \'";
       ...
       TStrmWy.str("");
       switch (Nazwy->WezSposobRys()) {
        case SR_Ciagly:
	   TStrmWy << "w l " << " lt " << Nazwy->WezStyl()
                   << " lw " << Nazwy->WezSzerokosc();
	     //         << " lc " << Nazwy->WezKolor();
           break;

        case SR_Punktowy:
	   TStrmWy << "w p " << " pt " << Nazwy->WezStyl()
                   << " ps " << Nazwy->WezSzerokosc();
	    //         << " lc " << Nazwy->WezKolor();
	   break;
...
/*
       (Nazwy->WezSposobRys() == SR_Ciagly ? " w l" : " w p pt 5");
       if  (Nazwy->WezSposobRys() == SR_Ciagly) 
 ...
 */
                                             ...
                                             )
 {
  ...
  for (; Nazwy != _InfoPlikow.end(); ++Nazwy ) {
     ...
     WczytajListeRoznychPunktow( Nazwy->WezNazwePliku().c_str(),
                                 ListaPunktow,
                                 Nazwy->WezKolor(), Nazwy->WezStyl(),
                                 Nazwy->WezEtykiete().c_str()
	                       );
